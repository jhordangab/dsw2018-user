...
<table style="font-size: 8px;">
    ...
    <thead>
        ...
        <tr style="background-color: #237486;">
            ...
            <th style="color: #FFFFFF;" colspan="2">OUTRAS RECEITAS / DESPESAS</th>
    ...
    <tbody class="body-valor">
        ...
        <tr style="background-color: #237486;">
            ...
            <?php for($i = 1; $i <= 12; $i++) : ?>
                ...
                <td style="color: #FFFFFF;"><?= number_format($sum[$i], 2, ',', '.'); ?></td>
            
            <?php endfor; ?>

            <td style="color: #FFFFFF;"><?= number_format($sum["total"], 2, ',', '.'); ?></td>
