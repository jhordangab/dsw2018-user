...
use app\magic\DreBiMagic;
use app\models\Indicador;
use kartik\mpdf\Pdf;

class ResultadoDreController extends Controller
{
    ...
    public function actionView($empresa_id, $ano)
    {
        ...
        $dados = DreBiMagic::get($empresa->nomeResumo, $ano);
        $indicador = Indicador::findOne(6);
	...
	date_default_timezone_set('America/Sao_Paulo');
        ...
        $title = 'DRE:: ' . $empresa->razaoSocial . ' / ' . $ano;
        ...
        $pdf = new Pdf([
            ...
            'methods' => 
            [
                'SetHeader' => ['BP1 Sistemas - DRE||' . $date],
