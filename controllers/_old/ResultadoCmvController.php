...
use app\magic\CmvBiMagic;
use app\models\Indicador;
use kartik\mpdf\Pdf;

class ResultadoCmvController extends Controller
{
    ...
    public function actionView($empresa_id, $ano)
    {
        ...
        $dados = CmvBiMagic::get($empresa->nomeResumo, $ano);
        $indicador = Indicador::findOne(3);
	...
	date_default_timezone_set('America/Sao_Paulo');
        ...
        $pdf = new Pdf([
            ...
            'methods' => 
            [
                'SetHeader' => ['BP1 Sistemas - CMV||' . $date],
