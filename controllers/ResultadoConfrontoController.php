...
class ResultadoConfrontoController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $indicador = Indicador::findOne(16);
    ...
    public function actionView($empresa_id, $ano)
    {
        ...
        $dados = ConfrontoBiMagic::get($empresa->nomeResumo, $ano);
        $indicador = Indicador::findOne(16);
	...
	date_default_timezone_set('America/Sao_Paulo');
        ...
        $empresa = AdminEmpresa::findOne($empresa_id);
        $dados = LalurBiMagic::get($empresa->nomeResumo, $ano);
        $content = $this->renderPartial('_partials/_table-pdf', compact('dados', 'empresa', 'ano'));
        $title = 'CMV:: ' . $empresa->razaoSocial . ' / ' . $ano;
        ...
        $pdf = new Pdf([
            ...
            'methods' => 
            [
                'SetHeader' => ['BP1 Sistemas - LALUR||' . $date],
