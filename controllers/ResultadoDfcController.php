...
use app\magic\DfcBiMagic;
use app\models\Indicador;
use kartik\mpdf\Pdf;

class ResultadoDfcController extends Controller
{
    ...
    public function actionView($empresa_id, $ano)
    {
        ...
        $dados = DfcBiMagic::get($empresa->nomeResumo, $ano);
        $indicador = Indicador::findOne(7);
	...
	date_default_timezone_set('America/Sao_Paulo');
        ...
        $pdf = new Pdf([
            ...
            'methods' => 
            [
                'SetHeader' => ['BP1 Sistemas - DFC||' . $date],
